...
export class PageComponent extends NgDocRootPage {
  ...
  readonly editSourceFileUrl: string = 'https://github.com/cborot/showingApp/edit/main/src/app/app.component.ts?message=docs(): describe your changes here...#L8';
  readonly viewSourceFileUrl: string = 'https://github.com/cborot/showingApp/blob/release/src/app/app.component.ts#L8';
