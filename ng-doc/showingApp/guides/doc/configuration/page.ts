...
const headerContent: string = `<h1 class="ngde ngde" id="configuration" href="configuration" headinglink="true">Configuration<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="configuration"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-kxpa5zug',
